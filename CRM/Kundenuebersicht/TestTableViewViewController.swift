...
//  CRM
//
//  Created by Noel Jander on 10.07.18.
...
class TestTableViewViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        func filterContentForSearchText(_ searchText: String, scope: String = "All") {
            filteredCustomers = customers.filter({(searchText) -> Bool in
                return customers.contains(searchText.lowercased())
            })
    ...
    extension CustomersViewController: UITableViewDataSource {
        ...
        func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
            ...
            //        if let customerValues = customersDictionary[customerKey] {
